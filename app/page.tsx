...
import { projectsQuery, servicesQuery, heroQuery, aboutQuery, conflictQuery, footerQuery } from "@/sanity/lib/queries";
...
export default async function Home() {
  ...
  if (projectId) {
    try {
      const [projectsData, servicesData, heroData, aboutData, conflictData, footerData] = await Promise.all([
